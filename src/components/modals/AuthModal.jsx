...
function AuthModal(props) {
  ...
  function submitHandler(event) {
    ...
    if (props.title.toLowerCase() == "change password") {
      url =
        "https://identitytoolkit.googleapis.com/v1/accounts:update?key=AIzaSyDzTttkMiFxbecSOKmdAJlERJtzmZEPW8Y";
    ...
    if (props.title.toLowerCase() == "signup") {
      url =
        "https://identitytoolkit.googleapis.com/v1/accounts:signUp?key=AIzaSyDzTttkMiFxbecSOKmdAJlERJtzmZEPW8Y";
    }

    if (props.title.toLowerCase() == "signin") {
      url =
        "https://identitytoolkit.googleapis.com/v1/accounts:signInWithPassword?key=AIzaSyDzTttkMiFxbecSOKmdAJlERJtzmZEPW8Y";
    }
